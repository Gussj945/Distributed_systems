...
import BoardServer
import LeaderElection #import Server.LeaderElection as LeaderElection
import logging
import Mutex as Mutex                          #import Server.Mutex as Mutex
import UseMutexForUpdates #import Server.UseMutexForUpdates as UseMutexForUpdates
import sys
...
# Start server
BoardServer.startServer(port, storage, serverID, mutex=mutex, leaderElection=leaderElection)